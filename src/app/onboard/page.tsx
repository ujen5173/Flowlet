...
import Logo from "~/components/rest/Logo";
...
export const metadata: Metadata = constructSEO({
  title: "Sign In to Flowlet – Continue Your Writing Journey",
  removeSiteName: true,
  description:
    "Access your Flowlet account to continue writing and sharing your ideas.",
});
  ...
  return (
    <main className="w-full relative min-h-screen flex items-center justify-center">
      ...
      <Card className="relative z-10 max-w-lg">
        ...
        <CardContent>
          <CardTitle className="text-center mb-6 text-xl text-slate-700 font-semibold">
            Log in or sign up
          </CardTitle>
          <div className="space-y-4">
            <Button
              ...
              size="lg"
              icon={() => (
                <svg className="size-4" viewBox="0 0 488 512">
                  <path
                    fill="#fff"
          ...
          <div className="relative flex items-center justify-center my-6">
            <div className="absolute top-1/2 -translate-y-1/2 left-0 w-[45%] bg-slate-300 h-px"></div>
            <span className="text-sm text-slate-700">or</span>
            <div className="absolute top-1/2 -translate-y-1/2 right-0 w-[45%] bg-slate-300 h-px"></div>
          </div>
        ...
        <CardFooter className="flex-col gap-2 mt-6">
          <p className="text-slate-600 leading-normal text-xs text-center">
